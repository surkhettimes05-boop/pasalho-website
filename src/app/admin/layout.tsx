        ...
        <aside className="w-64 bg-slate-900 text-white flex flex-col fixed inset-y-0 z-20">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <Link href="/admin" className={getLinkClass("/admin")}>
              <LayoutDashboard className={getIconClass("/admin", "text-orange-400")} />
              Dashboard
            </Link>
            <Link href="/admin/orders" className={getLinkClass("/admin/orders")}>
              <ShoppingCart className={getIconClass("/admin/orders", "text-orange-400")} />
              Orders
            </Link>
            <Link href="/admin/products" className={getLinkClass("/admin/products")}>
              <Package className={getIconClass("/admin/products", "text-orange-400")} />
              Products
            </Link>
            <Link href="/admin/customers" className={getLinkClass("/admin/customers")}>
              <Users className={getIconClass("/admin/customers", "text-orange-400")} />
              Customers
            </Link>
          </nav>
